            ...
            <div className="hidden lg:flex gap-6">
              {publicNavItems.map((item, idx) => (
                <div key={idx} className="relative group">
                  <Link
                    to={item.path}
                    className={`text-sm font-semibold transition duration-300 flex items-center gap-1 ${isActive(item.path)
                      ...
                      <div key={idx} className="w-full px-4">
                        {item.subItems && item.subItems.length > 0 ? (
                          ...
                          <Link
                            ...
                            className={`block text-sm font-semibold transition duration-300 py-2 text-center ${isActive(item.path)
                                ? 'text-white font-extrabold'
                                : 'text-white hover:text-gray-200'
                              }`}
                          >
